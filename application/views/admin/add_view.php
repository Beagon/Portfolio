      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="<?= base_url() ?>admin/add">Add Project</a></li>
          </ul>
        </div>
          ...
          <form class="form-horizontal" method="POST" enctype="multipart/form-data">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input id="subheader" name="subheader" type="text" placeholder="subheader" class="form-control" required="">
                </div>
              </div>
              <div class="form-group">
                <label class="form-label" for="text">Text:</label>
                <div class="controls">                     
                  <textarea id="text" name="text" class="form-control" maxlength="500" required=""></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="form-label" for="link">Link:</label>
                <div class="controls">
                  <input id="link" name="link" type="text" placeholder="url to the project" class="form-control" required="">
